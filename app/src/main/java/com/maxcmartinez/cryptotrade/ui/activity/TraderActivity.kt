...
import com.maxcmartinez.cryptotrade.adapter.CryptosAdapter
import com.maxcmartinez.cryptotrade.adapter.CryptosAdapterListener
...
import com.maxcmartinez.cryptotrade.network.RealtimeDataListener
                ...
                firestoreService.findUserById(username!!, object : Callback<User> {
                    override fun onSuccess(result: User?) {
                        ...
                        if (user!!.cryptosList == null) {
                            ...
                            firestoreService.updateUser(user!!, null)//enviamos los datos
                        }
                        loadUserCryptos()
